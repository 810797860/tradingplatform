(function(root, factory) {
    ...
    Paging.prototype = {
        ...
        bindEvent: function() {
            ...
            this.container.on('click', 'li.js-page-action,li.ui-pager', function(e) {
                ...
                if ($(this).hasClass('js-page-action')) {
                    ...
                    $('#pageToolbar').attr('data-currentpage', _this.current)
                }
                _this.go();
            });
            /*
        ...
        go: function(p) {
            ...
            $('#pageToolbar').data().currentpage = this.current;
            var currentPage = $('#pageToolbar').data().currentpage;
        ...
        format: function() {
            ...
            html += '<li class="js-page-next js-page-action ui-pager page-down">' + this.settings.nextTpl + '</li>';
            html += '<span>跳至</span>'
