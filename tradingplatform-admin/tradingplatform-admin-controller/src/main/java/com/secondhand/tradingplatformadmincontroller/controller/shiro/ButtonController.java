...
public class ButtonController extends BaseController {
    ...
    public String toButtonList(Model model) {
    ...
    public String toUpdateButton(Model model, @PathVariable(value = "buttonId") Long buttonId) {
        //静态注入要回显的数据
    ...
    public String toCreateButton(Model model) {
        return "button/newButton";
    }
