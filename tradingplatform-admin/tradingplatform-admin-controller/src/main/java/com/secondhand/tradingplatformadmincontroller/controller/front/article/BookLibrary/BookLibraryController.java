...
public class BookLibraryController extends BaseController {
    ...
    /**
     * @description : 立即购买bookLibrary
     * @author : zhangjk
     * @since : Create in 2019-04-09
     */
    @GetMapping(value = "/settlement/{bookLibraryId}", produces = {MediaType.APPLICATION_JSON_VALUE}, consumes = {MediaType.APPLICATION_JSON_VALUE})
    @ApiOperation(value = "/settlement/{bookLibraryId}", notes = "立即购买bookLibrary")
    @ResponseBody
    public JsonResult<Float> toSettlement(@ApiParam(name = "id", value = "bookLibraryId") @PathVariable(value = "bookLibraryId") Long bookLibraryId) throws ClientException, CustomizeException {
        ...
        try {
            ...
            balance = bookLibraryService.mySettlementById(bookLibraryId, balance, user.getId());
