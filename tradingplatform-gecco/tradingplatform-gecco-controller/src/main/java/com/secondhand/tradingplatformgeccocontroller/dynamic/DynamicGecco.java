...
public class DynamicGecco {
	...
	public static JavassistDynamicBean html() {
		return new JavassistDynamicBean("com.secondhand.tradingplatformgeccocontroller.dynamic.HtlmBean"+RandomStringUtils.randomAlphabetic(6)+System.nanoTime(), JavassistDynamicBean.HtmlBean);
	}
	
	public static JavassistDynamicBean json() {
		return new JavassistDynamicBean("com.secondhand.tradingplatformgeccocontroller.dynamic.JsonBean"+RandomStringUtils.randomAlphabetic(6)+System.nanoTime(), JavassistDynamicBean.JsonBean);
	}
