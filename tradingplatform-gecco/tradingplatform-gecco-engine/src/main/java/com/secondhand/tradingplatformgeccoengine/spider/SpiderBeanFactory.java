...
import com.secondhand.tradingplatformgeccoengine.downloader.DownloaderAOPFactory;
import com.secondhand.tradingplatformgeccoengine.downloader.DownloaderFactory;
import com.secondhand.tradingplatformgeccoengine.downloader.MonitorDownloaderFactory;
import com.secondhand.tradingplatformgeccoengine.dynamic.GeccoClassLoader;
import com.secondhand.tradingplatformgeccoengine.dynamic.GeccoJavaReflectionAdapter;
import com.secondhand.tradingplatformgeccoengine.pipeline.DefaultPipelineFactory;
import com.secondhand.tradingplatformgeccoengine.pipeline.Pipeline;
import com.secondhand.tradingplatformgeccoengine.pipeline.PipelineFactory;
import com.secondhand.tradingplatformgeccoengine.request.HttpRequest;
import com.secondhand.tradingplatformgeccoengine.spider.render.MonitorRenderFactory;
import com.secondhand.tradingplatformgeccoengine.spider.render.RenderFactory;
import com.secondhand.tradingplatformgeccoengine.spider.render.RenderType;
	...
	public SpiderBeanFactory(String classPath, PipelineFactory pipelineFactory) {
		if (StringUtils.isNotEmpty(classPath)) {
			reflections = new Reflections(
					ConfigurationBuilder.build("com.secondhand.tradingplatformgeccoengine", classPath, GeccoClassLoader.get())
							.setMetadataAdapter(new GeccoJavaReflectionAdapter())
							.setExpandSuperTypes(false));
			// reflections = new Reflections("com.secondhand.tradingplatformgeccoengine", classPath);
		} else {
			reflections = new Reflections(ConfigurationBuilder.build("com.secondhand.tradingplatformgeccoengine", GeccoClassLoader.get())
					.setMetadataAdapter(new GeccoJavaReflectionAdapter())
					.setExpandSuperTypes(false));
			// reflections = new Reflections("com.secondhand.tradingplatformgeccoengine");
		}
		dynamic();
